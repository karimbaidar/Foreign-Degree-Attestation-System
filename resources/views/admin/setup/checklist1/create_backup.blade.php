 ...
 @if(Auth::user()->lastName == "Attestation")
 	...
 	<div class="row">
 			<div class="col-md-2 col-sm-12 col-xs-12">
				...
				<div class="col-md-8 col-sm-12 col-xs-12">
					<div class="x_panel">
						<div class="x_title">
							<h2 style="padding-bottom:5px">تایید امریت ارزیابی اسناد تحصیلی خارج مرز</h2>
	...
	<!-- Text input-->
									...
									<div class="form-group{{ $errors->has('nationality') ? ' has-error' : '' }}">
										<label class="col-md-4 control-label" for="nationality">اصل دیپلوم تحصیلی دوره ماستر</label>  
										<div class="col-md-4">
									...
									<div class="form-group{{ $errors->has('nationality') ? ' has-error' : '' }}">
										<label class="col-md-4 control-label" for="nationality">ديپلوم لایسنس</label>  
										<div class="col-md-4">
									...
									<div class="form-group{{ $errors->has('nationality') ? ' has-error' : '' }}">
										<label class="col-md-4 control-label" for="nationality">اصل ترانسکرپت نمرات</label>  
										<div class="col-md-4">
									...
									<div class="form-group{{ $errors->has('nationality') ? ' has-error' : '' }}">
										<label class="col-md-4 control-label" for="nationality">پاسپورت تحصیلی یا کارت اقامت</label>  
										<div class="col-md-4">
										<input id="nationality" name="bank_varification"  type="checkbox" class="form-control input-md" {{$doctor->bank_varification==1?'checked':''}}/>
										</div>
									</div>
									<div class="form-group{{ $errors->has('nationality') ? ' has-error' : '' }}">
										<label class="col-md-4 control-label" for="nationality">کارت پوهنتون</label>  
										<div class="col-md-4">
									...
									<div class="form-group{{ $errors->has('nationality') ? ' has-error' : '' }}">
										<label class="col-md-4 control-label" for="nationality">تکمیل نمودن فورم ارزیابی توسط شخص فارغ</label>  
										<div class="col-md-4">
										<input id="nationality" name="fit_to_work"   type="checkbox" class="form-control input-md" {{$doctor->fit_to_work==1?'checked':''}}/>
										</div>
									</div>
									<div class="form-group{{ $errors->has('nationality') ? ' has-error' : '' }}">
										<label class="col-md-4 control-label" for="nationality">فورم م 25</label>  
										<div class="col-md-4">
										<input id="nationality" name="declaration"   type="checkbox" class="form-control input-md" {{$doctor->diclaration==1?'checked':''}}/>
										</div>
									</div>
									<div class="form-group{{ $errors->has('nationality') ? ' has-error' : '' }}">
										<label class="col-md-4 control-label" for="nationality">تائید </label>  
										<div class="col-md-4">
									...
									<div class="form-group{{ $errors->has('nationality') ? ' has-error' : '' }}">
										<label class="col-md-4 control-label" for="nationality">توضیح رد</label>  
										<div class="col-md-4">
									...
									<div class="form-group{{ $errors->has('nationality') ? ' has-error' : '' }}">
										<label class="col-md-4 control-label" for="nationality">توضیح ناقص سند</label>  
										<div class="col-md-4">
                ...
                <div class="form-group">
                     <div class="text-center">
						  ...
						  <button type="submit" class="btn btn-danger">{{__('ui-list.reject')}}</button>
						   <button type="submit" class="btn btn-danger">{{__('ui-list.documentincompletebutton')}}</button>
