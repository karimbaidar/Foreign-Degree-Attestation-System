	    	...
	    	<div class="col-md-4 col-sm-6 col-xs-12">
                       ...
                       <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group {{$errors->has('code')?'has_error':''}}">
                          ...
                          <div class="col-md-7">
                          <input id="reg_no" name="reg_no" required  readonly type="text" value="{{$doctor->surname}}" class="form-control input-md">   
                          </div>
                          </div>
                       </div>
					...
					<br/>
                       ...
                       <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group {{$errors->has('code')?'has_error':''}}">
                          ...
                          <div class="col-md-7">
                          <input id="reg_no" name="reg_no" required  readonly type="text" value="{{$doctor->Protocol}}" class="form-control input-md">   
                          </div>
                          </div>
                       </div>
                       <div class="col-md-4 col-sm-6 col-xs-12">
...
@endif
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                         ...
                         <div class="form-group {{$errors->has('code')?'has_error':''}}">
                          ...
                          <div class="col-md-7">
                          <input id="reg_no" name="reg_no" required disabled  readonly  type="text"  value="{{ $doctor->reg_no }}" class="form-control input-md">   
                          </div>
                          </div>
                       </div>
					  ...
					  <div class="col-md-4 col-sm-6 col-xs-12">
                       ...
                       <div class="col-md-4 col-sm-6 col-xs-12">
                         ...
                         <div class="form-group {{$errors->has('code')?'has_error':''}}">
                          <label class="col-md-5 control-label" for="code"><div align="left">     </div></label>  
                          <div class="col-md-7">
                          <input id="reg_no" name="reg_no" style="display:none" required  readonly  type="text"  value="{{ $doctor->reg_no }}" class="form-control input-md">   
                          </div>
                          </div>
                       </div>
            ...
            <div class="form-group">
                  <div class="text-center">
          	        ...
          	        @unless (!empty($technicalcomments_register->flagattestation) )  
...
@elseif($technicalcomments_register->adminapproval == 2)
