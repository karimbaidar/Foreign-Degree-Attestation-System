			...
			<div class="x_panel">
				...
				@endif
				 >    <i class="fa fa-plus"></i>{{__('ui.add')}} </a> 
					<div class="x_title">
							<h2 style="padding-bottom:5px">University</h2>
						...
						<td class="text-center">
							...
							{{method_field('delete')}}
								<div class=" " role="group">
									<a class="btn btn-primary" href="{{'/university/'.$university->id.'/edit'}}"><i class="fa fa-edit"></i>{{__('ui.edit')}}</a>
