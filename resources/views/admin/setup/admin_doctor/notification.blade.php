...
@section('page-content')
	...
	<div class="row" style="margin-top:20px">
		...
		<div class="col-md-6 col-sm-12 col-xs-12">
			...
			<div class="x_panel">
				<div class="x_title">
					<h4 style="padding-bottom:5px">{{__('ui-list.notifications')}}</h4>
			  ...
			  <table  id="#" class="table table-condensed table-hover table-striped" border="1px solid" style="font-size:16px">
				<thead>
					<tr>			
						<th>{{__('ui-list.description')}}</th>
