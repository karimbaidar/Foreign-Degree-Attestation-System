			...
			<div class="row">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 col-sm-12 col-xs-12" style="float:right">
                         ...
                         <div class="col-md-12" style="background-color: lightgray">
                          	...
                          	<h4 style="text-align: center"><b>فورم برای تائیدی ماستری </b></h4>
...
<!-- Start of Educational Qualification -->
      ...
      <tr class="table_rows" >
						...
						<td width="15%"><input type="text" tabindex="33" required readonly  id ="degree" name="degree" value="Master" class="form-control input-md" />   <span></span></td>
