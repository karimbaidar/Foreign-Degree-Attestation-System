		...
		<div class="col-md-10 col-sm-12 col-xs-12">
			<div class="x_panel" style="min-height: 700px">
				 ...
				 <div class="x_title text-center" style="padding:5px">
                        <img src="{{url('/images/logo.png')}}" style="width:100px;height:100px;border-radius:0%"></img>   
...
<div class="col-md-4 col-sm-6 col-xs-12">
              ...
              <div class="col-md-7">
              <input id="name" name="name" required  placeholder="کریم" tabindex="1"  type="text" value="{{old('name')}}" class="form-control input-md"  title ="Number is Not Allowed" maxlength="30" minlength="2" >
                  <span></span>
              </div>
              </div>
...
<div class="col-md-4 col-sm-6 col-xs-12">
              ...
              <div class="col-md-7">
              <input id="surname" name="surname" required placeholder="بیدار" tabindex="2"   type="text" value="{{old('surname')}}" class="form-control input-md"  title ="Number is Not Allowed" maxlength="30" minlength="2" >
              <span></span>
              </div>
              </div>
...
<div class="col-md-4 col-sm-6 col-xs-12">
              ...
              <div class="col-md-7">
              <input id="father_name" tabindex="3" required placeholder="سمون"  name="father_name"  type="text" value="{{old('father_name')}}" class="form-control input-md"  title ="Number is Not Allowed" maxlength="30" minlength="2" >
              <span></span>
              </div>
              </div>
...
<div class="col-md-4 col-sm-6 col-xs-12">
    <!-- Text input-->
              ...
              <div class="col-md-7">
              <input id="PersonalCellPhone" required tabindex="4" placeholder="0091778178438" name="PersonalCellPhone"  type="text" pattern="[0-9]{4}[0-9]{3}[0-9]{6}"  title="Text is not allowed" value="{{old('PersonalCellPhone')}}" class="form-control input-md" >
                  <span></span>
              </div>
              </div>
    </div>
