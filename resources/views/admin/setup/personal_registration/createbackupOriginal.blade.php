...
-->
    ...
    <div class="col-md-1 col-sm-13 col-xs-15">
	    ...
	    <fieldset>
         ...
         <div class="form-group {{$errors->has('code')?'has_error':''}}">
                          ...
                          <input id="id" name="id" required    type="text" style="display:none" value="{{$user_idPersonal}}" class="form-control input-md">   
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                          ...
                          <div class="col-md-7">
                          <input id="PersonalEmail" readonly  required placeholder="example@gmail.com" name="PersonalEmail"  type="email" value="{{$personalCreate_reg_no->PersonalEmail}}"    class="form-control input-md">
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
                          ...
                          <div class="col-md-7">
                          <input id="name" name="name"  placeholder="کریم" tabindex="1"  type="text"   value="{{$personalCreate_reg_no->name}}"                     class="form-control input-md"  title ="Number is Not Allowed" maxlength="30" minlength="2" required>
                              <span></span>
                          </div>
                          </div>
				 ...
				 <div class="col-md-4 col-sm-6 col-xs-12">
                          ...
                          <div class="col-md-7">
                          <input id="surname" name="surname" placeholder="بیدار" tabindex="2"   type="text"      value="{{$personalCreate_reg_no->surname}}" class="form-control input-md"  title ="Number is Not Allowed" maxlength="30" minlength="2" required>
                          <span></span>
                          </div>
                          </div>
				 ...
				 <div class="col-md-4 col-sm-6 col-xs-12">
                          ...
                          <div class="col-md-7">
                          <input id="father_name" tabindex="3" placeholder="سمون"  name="father_name"    type="text" value="{{$personalCreate_reg_no->father_name}}" class="form-control input-md"  title ="Number is Not Allowed" maxlength="30" minlength="2" required>
                          <span></span>
                          </div>
                          </div>
				 ...
				 <div class="col-md-4 col-sm-6 col-xs-12">
                          ...
                          <div class="col-md-7">
                          <input id="PersonalCellPhone" tabindex="4" placeholder="0091778178438"    name="PersonalCellPhone"  type="text" pattern="[0-9]{4}[0-9]{3}[0-9]{6}"  title="Text is not allowed" value="{{$personalCreate_reg_no->PersonalCellPhone}}" class="form-control input-md" required>
                              <span></span>
                          </div>
                          </div>
                </div>
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
                          ...
                          <div class="col-md-7">
                          <input id="PAddress" required tabindex="5" name="PAddress"    placeholder="City, District, Street"  type="text" value="{{$personalCreate_reg_no->PAddress}}" class="form-control input-md"  title="Your address should contain city and street number">
                            <span></span>
                          </div>
                          </div>
                </div>
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
                          ...
                          <div class="col-md-7">
                          <input id="CAddress" required tabindex="6" name="CAddress"    placeholder="City, District, Street" type="text" value="{{$personalCreate_reg_no->CAddress}}" class="form-control input-md"  title="Please enter city and street number">
                              <span></span>
                          </div>
                          </div>
                </div>
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
                          ...
                          <div class="col-md-7">
                          <input id="nic" tabindex="7" required  name="nic"    placeholder="10607432" type="text" value="{{$personalCreate_reg_no->nic}}" class="form-control input-md"  title="Your Tazkira Number">
                              <span></span>
                          </div>
                          </div>
                </div>
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
                          ...
                          <div class="col-md-7">
                          <input id="dob" tabindex="8" required  name="dob"    type="text" placeholder="DD.MM.YYYY"  pattern="^[1-4]\d{3}\/((0[1-6]\/((3[0-1])|([1-2][0-9])|(0[1-9])))|((1[0-2]|(0[7-9]))\/(30|31|([1-2][0-9])|(0[1-9]))))$"  title="The date format should be Day/Month/Year" value="{{$personalCreate_reg_no->dob}}" class="form-control input-md">
                             <span></span> 
                          </div>
                          </div>
                </div>
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
                          ...
                          <div class="col-md-7">
                          <input id="Pbirth" tabindex="9"  placeholder="City, Country"    name="Pbirth"  type="text" value="{{$personalCreate_reg_no->Pbirth}}" class="form-control input-md"  title ="Number is Not Allowed" maxlength="30" minlength="2" required>
                              <span></span>
                          </div>
                          </div>
                </div>
          ...
          <div class="x_panel">
            ...
            <input accept="image/png, image/jpeg, image/jpeg" onchange="document.getElementById('imgDisplayarea').src=window.URL.createObjectURL(this.files[0])" id="image" tabindex="10"  name="image"  type="file"  value="{{$personalCreate_reg_no->image}}"/>

            <img src=" {{ asset('storage/documents/'.$personalCreate_reg_no->image) }}" style="width:220px;height:220px;" />
     ...
     <div class="row">
				...
				<!--<div class="col-md-4 col-sm-6 col-xs-12">
				  ...
				  <div class="col-md-4 col-sm-6 col-xs-12">
				   <div class="form-group{{$errors->has('receive_date')?'has-error':''}}">
				    <label class="col-md-5 control-label" for="order_date"><div align="left">{{__('ui-list.issueingCountry')}}*</div></label>  
					 <td><input id="issueingCountry" tabindex="5"     name="issueingCountry"    type="text" value="{{$EducationalCreate_reg_no->issueingCountry}}" class="form-control input-md"></td>
				 </div>
				 </div>
				 ...
				 <div class="col-md-4 col-sm-6 col-xs-12">
                          ...
                          <div class="col-md-7">
                          <input id="DiplomaNumber"  name="DiplomaNumber" placeholder="654545"    tabindex="12"  type="text" value="{{$EducationalCreate_reg_no->DiplomaNumber}}" class="form-control input-md"  title="Please enter your diploma number">
                            <span></span>
                          </div>
                          </div>
                 </div>
				 ...
				 <div class="col-md-4 col-sm-6 col-xs-12">
                          ...
                          <div class="col-md-7">
                          <input id="TranscriptNumber"    name="TranscriptNumber" placeholder="54544" tabindex="13"  type="text" value="{{$EducationalCreate_reg_no->TranscriptNumber}}" class="form-control input-md"  title="Please enter your transcript number">
                              <span></span>
                          </div>
                          </div>
                 </div>
				 ...
				 <div class="col-md-4 col-sm-6 col-xs-12">
                          ...
                          <div class="col-md-7">
                          <input id="thesistitle"    name="thesistitle"  value="{{$EducationalCreate_reg_no->thesistitle}}" tabindex="14" type="text" placeholder="Developing 2D Architecture" class="form-control input-md"  title="Your thesis Title">
                              <span></span>
                          </div>
                          </div>
						</div>
	...
	<div class="row">
				<div class="col-md-4 col-sm-6 col-xs-12">
                          ...
                          <div class="col-md-7">
                          <input id="Grade"  tabindex="18"    placeholder="A" name="Grade"  type="text" value="{{$EducationalCreate_reg_no->Grade}}" class="form-control input-md"  title="Your Grade">
                              <span></span>
                          </div>
                          </div>
                </div>
				   ...
				   <div class="col-md-4 col-sm-6 col-xs-12">
                          ...
                          <input id="UniID" tabindex="19"    name="UniID" placeholder="621555" type="text" value="{{$EducationalCreate_reg_no->UniID}}" class="form-control input-md"  title="Your University ID">
                            <span></span>
                          </div>
                          </div>
                </div>
				 <div class="col-md-4 col-sm-6 col-xs-12">
                          ...
                          <div class="col-md-7">
                          <input id="RollNum" tabindex="20"    name="RollNum" placeholder="05" type="text" value="{{$EducationalCreate_reg_no->RollNum}}" class="form-control input-md"  title="Your Roll Number">
                              <span></span>
                          </div>
                          </div>
                </div>
	...
	<div class="row">
				 ...
				 <div class="col-md-4 col-sm-6 col-xs-12">
                          ...
                          <div class="col-md-7">
                          <input id="StudyDuration" tabindex="21"    placeholder="4" name="StudyDuration"  type="number" value="{{$EducationalCreate_reg_no->StudyDuration}}" class="form-control input-md" required>
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
                          ...
                          <div class="col-md-7">
                          <input id="FEducation" tabindex="22"    name="FEducation" placeholder="Computer Science" type="text" value="{{$EducationalCreate_reg_no->FEducation}}" class="form-control input-md"  title ="Number is Not Allowed" maxlength="30" minlength="2" >
                                    <span></span>
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
                          ...
                          <div class="col-md-7">
                          <input id="GPA" tabindex="23" name="GPA"    placeholder="3.5" type="number" step="any" value="{{$EducationalCreate_reg_no->GPA}}" class="form-control input-md">
...
<div class="row">	 
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
                          ...
                          <div class="col-md-7">
                          <input id="AYear" tabindex="25" required    name="AYear" placeholder="2009" type="number" value="{{$EducationalCreate_reg_no->AYear}}" class="form-control input-md">
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
                          ...
                          <div class="col-md-7">
                          <input id="GYear" tabindex="26" required     name="GYear" placeholder="2012" type="number" value="{{$EducationalCreate_reg_no->GYear}}" class="form-control input-md">
...
<div class="row">
           		 ...
           		 <div class="col-md-4 col-sm-6 col-xs-12">
                          ...
                          <div class="col-md-7">
                          <textarea id="details" tabindex="27"    name="details" placeholder="{{__('ui-list.details3')}}" type="text" cols="40" rows="5">{{$EducationalCreate_reg_no->details}}</textarea>
                          </div>
                          </div>
                </div>
      ...
      <tr class="table_rows" >
						...
						<td width="15%">
						     ...
						     <select required name="degree"    class="form-control product" >
                              <option value="{{$UniversityCreate->degree}}" >{{$UniversityCreate->degree}}</option>
                        ...
                        <td><input type="text" name="from_date" tabindex = "29" required placeholder="DD.MM.YYYY"    value="{{$UniversityCreate->from_date}}" name="from_date"  pattern="^[1-4]\d{3}\/((0[1-6]\/((3[0-1])|([1-2][0-9])|(0[1-9])))|((1[0-2]|(0[7-9]))\/(30|31|([1-2][0-9])|(0[1-9]))))$"  title="The date format should be Day/Month/Year" class=" form-control"/> <span></span> 
						...
						<td><input type="text" name="to_date" tabindex = "30" required placeholder="DD.MM.YYYY"     name="to_date" value="{{$UniversityCreate->to_date}}"   pattern="^[1-4]\d{3}\/((0[1-6]\/((3[0-1])|([1-2][0-9])|(0[1-9])))|((1[0-2]|(0[7-9]))\/(30|31|([1-2][0-9])|(0[1-9]))))$" title="The date format should be Day/Month/Year" class="form-control"/>
					<br/><small class="text-danger">{{ $errors->first('to_date') }} </small>
					  ...
					  <td >
                     <input type="text" name="university" tabindex = "30" required placeholder="University Name"    name="university" value="{{$UniversityCreate->university}}"   title="University Name" class="form-control"/></td>
                     
                      <td width="12%"><input type="email" tabindex="32" placeholder="info@mit.com"    required class="form-control quantity" value="{{$UniversityCreate->PersonalEmail2}}" name="PersonalEmail2"/> 
					  <input type="email" tabindex="32" placeholder="info@mit.com"  class="form-control quantity"      /> 
                    
					  
					  </td>
                     
					 <td width="15%">
					 <input type="text" tabindex="33" required   name="PersonalPhon2" placeholder="009102025691162"    value="{{$UniversityCreate->PersonalPhon2}}" class="form-control input-md" />   
           ...
           <input type="file" tabindex="34"  class="form-control quantity" name="file_name" value="{{$UniversityCreate->file_name}}" accept="application/pdf" /><span></span>
           <a href=" {{ asset('storage/documents/'.$UniversityCreate->file_name) }}" target="_blank">{{$UniversityCreate->file_name}}</a>
