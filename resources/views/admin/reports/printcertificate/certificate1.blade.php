...
<div class="x_title text-center" style="padding:5px">
														...
														<table  width="100%" 	>
                                                          <tr>
                                                            ...
                                                            <td><img src="{{URL::asset('images/logo.png')}}" style="width:100px;height:100px;border-radius:40%"></img>
															</td>
                                                            <td align="center"><b>
															...
															<td><img src="{{URL::asset('images/logo.png')}}" style="width:100px;height:100px;border-radius:50%"></img>
															</td>
...
<tr>
<td width="83">
<p>{{$registred_doctor->DiplomaNumber}}</p>
</td>
<td width="96">
<p>{{$registred_doctor->TranscriptNumber}}</p>
</td>
<td width="96">
<p>{{$registred_doctor->university}} - {{$registred_doctor->g_fathername}}</p>
</td>
<td width="120">
<p>  {{$registred_doctor->degree}} - ماستری با تیزس</p>
</td>
<td width="90">
<p>از {{$registred_doctor->from_date}} - تا {{$registred_doctor->to_date}}</p>
</td>
</tr>
<tr>
<td width="83">
...
<tr>
<td width="83">
<p>{{$registred_doctor->Grade}}</p>
</td>
<td colspan="2" width="192">
<p>{{$registred_doctor->GPA}}</p>
</td>
<td colspan="2" width="210">
@if($registred_doctor->EDocument == 1)
<p>{{__('ui-list.original')}}</p>
@elseif($registred_doctor->EDocument == 2)
<p>{{__('ui-list.temporary')}}</p>
@endif()
</td>
</tr>
</tbody>
