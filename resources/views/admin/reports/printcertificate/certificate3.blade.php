...
<tbody>
<tr>
 <div align="right">فورم 1 ارزیابی سند تحصیلی مقطع لیسانس 
...
<tr>
<td class="borderexample" colspan="17" width="680">University E-mail:{{$registred_doctor->address}}</td class="borderexample">
</tr>
<tr>
<td class="borderexample" colspan="17" width="680">U.Tel:{{$registred_doctor->contact}}</td class="borderexample">
...
<p style="text-align: right;"><strong><u>جلسه مورخ:        /        / 1396</u></strong></p>
<p style="text-align: right; direction:rtl;" ><strong>
...
دیپلوم تحصیلی شماره ({{$registred_doctor->DiplomaNumber}}) صادر شده از پوهنتون ({{$registred_doctor->university}})
 ...
 رشته  ({{$registred_doctor->FEducation}})به نام محترم ({{$registred_doctor->name}})فــرزند ({{$registred_doctor->fatherName}})دارنده نذکره/پاسپورت نمــــــــــــــبر({{$registred_doctor->nic}})که در سال({{$registred_doctor->AYEar}})شامل
...
نوعیت تحصیل ({{$registred_doctor->typeEducation}}) بر اساس (                                                                            )، ثبت پرپروتوکـول شماره (           ) ارزیابی و (                  ) است.
 ...
 <p style="text-align: right;"><strong>نتیجه نهایی کمیسیون ارزیابی :           تائید </strong><strong>□</strong><strong>          رد </strong><strong>□       </strong>
...
<br/>
 	<strong>مهر، امضا وتصديق موسسه تحصيلي مربوطه و وزارت تحصيلات عالي كشور اعطا کننده اسناد.</strong><br/>
 	<strong>تصدیق وزارت خارجه کشور اعطا کننده اسناد.</strong><br/>
 	<strong>تائيد نمايندگي سياسي افغانستان(سفارت يا قونسلگري افغانستان) در كشور صادر كننده اسناد تحصيلي </strong><br/>
 	<strong>تائيد رياست قونسلي وزارت امورخارجه ازمهر نمايندگي افغانستان درخارج از كشور.</strong><br/>


 	<strong>اسناد تحصیلی بايد داراي ترانسكرپت نمرات باشد.</strong><br/>
 	<strong>سند فراغت بايد داراي تسلسل رشتوي واكادميك باشد.</strong><br/>
 	<strong>در موقع ارائه سند فراغت تذكره هويت دارنده آن حتمی است.</strong><br/>
 	<strong>وجود تيزس براي دوره‌های ماستری و دکتورا حتمی می‌باشد و ماستری‌های بدون تیزس در روند ارزیابی مستند گردد.</strong><br/>
 	<strong>پرداخت </strong><strong>حق الخدمت سند تحصیلی</strong><strong> مورد ارزیابی</strong> <strong>[</strong><strong>دوره دکتورا(۱۰۰۰)افغانی</strong><strong>، ماستری (800)افغانی ولیسانس (600)افغانی].</strong><br/>
 	<strong>غرض ارزيابي اسناد فراغت تحصيلي دست داشته ، داشتن سند اسناد تحصيلي فراغت يك دوره قبلي ضروري ميباشد.</strong><br/>
 	<strong>تكميل فورم ارزيابي ضروري مي‌باشد.</strong><br/>
 	<strong>فارغ التحصیل مکلف است تا سند تائید کننده نوع تحصیل (حضوری ، نیمه حضوری غیر حضوری) را ارائه نماید. درصورت عدم ارائه چین سند، فارغ التحصیل مکلف است تا ادرس فعال و موثق مرجع تحصیلی را ارائه نماید.</strong><br/>
