...
body{
	...
	font-size:100%;
	background: url(<?php echo e(URL::asset('/images/bg.jpg')); ?>); no-repeat;
...
.checkbox input + i:after {
	content: '';
	background: url("<?php echo e(Storage::url('public/documents/mark.png')); ?>"); no-repeat 3px 2px;
	top: -1px;
	left: -1px;
	width: 15px;
	height: 15px;
...
<!-- start-form -->
<center>
    <img src="<?php echo e(url('/images/logo.png')); ?>" width="150px" height="150px" alt=""><br/>
    <h3>Sorry! You are LoggedIn, Please Logout First from the Dashboard</h3><br/>
    <h4>Go to Dashboard :  <a href = "<?php echo e(URL::route('home')); ?>" target = container>Dashboard</a> </h4>
</center>
...
<div class="contact-form">
<!-- start-form -->
	<form class="contact_form" role="form" action="<?php echo e(route('login')); ?>" method="post">
 ...
 <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                ...
                <?php endif; ?>
                 <?php if($errors->has('email')): ?>
                                                                        <span class="help-block">
                                                                         <font color="red">  <strong><?php echo e($errors->first('email')); ?></strong> </font> 
                                                                        </span>
                 <?php endif; ?>
				 
		<!--<h1><?php echo e(__('ui-list.login_mohe_account')); ?></h1>-->
	    <ul>
	        <li>
			   ...
			   <input type="email" class="textbox1" name="email" placeholder="info@gmail.com" required onkeyup="if(this.value.length > 0) document.getElementById('baidar1').disabled = false; else document.getElementById('baidar1').disabled = true;"/>
	            <span class="form_hint">Enter a valid email</span>
	             ...
	             <p><img src="<?php echo e(Storage::url('public/documents/contact.png')); ?>" alt=""></p>
	        </li>
	        <li>
				<div class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
	            <input type="password" name="password" class="textbox2" placeholder="password">
			
	            <p><img src="<?php echo e(Storage::url('public/documents/lock.png')); ?>" alt=""></p>  <br/><br/>
	        </li>
         </ul>
...
<div class="account">
    <br/>
    <center> <img src="<?php echo e(url('/images/logo.png')); ?>" width="150px" height="150px" alt=""> </center>
<center>
  <div class="submit2">  <a href="/register/" ><i><?php echo e(__('ui-list.registeration_here')); ?> >>&nbsp;</i><div class="clear"></div></a></div>	
   	<div class="submit1">
		            
		            	<a href="/doctor">
		
	<b><?php echo e(__('ui-list.search_verified_students')); ?></b> 
