...
.hide-loading{
 ...
 <!-- top navigation -->
      ...
      ?>
		    	<?php if(Auth::user()->status == 0 && Auth::user()->lastName != 'Administrator' 
				...
				&& Auth::user()->lastName != 'CommissionDirector' && Auth::user()->lastName != 'Balakarzai'
                                ...
                                <a href="notification" class="submit_nav4"> <span class="glyphicon glyphicon-check"><b><?php echo e(__('ui-list.notifications')); ?></b></span></a>
...
<table><tr>
<td>
<button class="submit_nav1" id="locale"   name="locale"   value="en" <?php echo e(App::getLocale()=='en'?'selected':''); ?>  ><?php echo e(__('ui.english')); ?></button>
</td>
<td>
<button class="submit_nav2" id="locale"   name="locale"   value="fa" <?php echo e(App::getLocale()=='fa'?'selected':''); ?>  ><?php echo e(__('ui.dari')); ?></button>
</td>
<td>
<button class="submit_nav3" id="locale"   name="locale"   value="ps" <?php echo e(App::getLocale()=='ps'?'selected':''); ?>  ><?php echo e(__('ui.pashtu')); ?></button>
</td>
</tr>
</table>
</center>
