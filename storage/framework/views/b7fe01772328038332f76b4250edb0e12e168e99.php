...
<?php $__env->startSection('page-content'); ?>
 ...
 <?php if(Auth::user()->lastName == "TechnicalCommittee"): ?>
	    	...
	    	<div class="col-md-4 col-sm-6 col-xs-12">
                       ...
                       <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                          <input id="reg_no" name="reg_no" required  readonly type="text" value="<?php echo e($doctor->surname); ?>" class="form-control input-md">   
                          </div>
                          </div>
                       </div>
					...
					<br/>
                       ...
                       <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                          <input id="reg_no" name="reg_no" required  readonly type="text" value="<?php echo e($doctor->Protocol); ?>" class="form-control input-md">   
                          </div>
                          </div>
                       </div>
                       <div class="col-md-4 col-sm-6 col-xs-12">
...
<?php endif; ?>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                         ...
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                          <input id="reg_no" name="reg_no" required disabled  readonly  type="text"  value="<?php echo e($doctor->reg_no); ?>" class="form-control input-md">   
                          </div>
                          </div>
                       </div>
			...
			<div class="row">
 			<div class="col-md-10 col-sm-15 col-xs-14">
				...
				<div class="col-md-12 col-sm-15 col-xs-14">
					...
					<div class="x_content">
							<br />
						<form  action="<?php echo e('/check_list2/'); ?>" method="post" class="form-horizontal form-label-left">
					  ...
					  <div class="col-md-4 col-sm-6 col-xs-12">
                       ...
                       <div class="col-md-4 col-sm-6 col-xs-12">
                         ...
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          <label class="col-md-5 control-label" for="code"><div align="left">     </div></label>  
                          <div class="col-md-7">
                          <input id="reg_no" name="reg_no" style="display:none" required  readonly  type="text"  value="<?php echo e($doctor->reg_no); ?>" class="form-control input-md">   
                          </div>
                          </div>
                       </div>
                  ...
                  <?php if (! ( empty($technicalcomments_register->Permanent) )): ?>    
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          <label class="col-md-5 control-label" for="code"><div align="left">  موقت  </div></label>  
                          <div class="col-md-7">
                         	<input id="Temporary" name="Temporary"   type="checkbox"  class="form-control input-md" />  
                          </div>
                          </div>
                       </div>
                         ...
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          <label class="col-md-5 control-label" for="code"><div align="left">  دایم  </div></label>  
                          <div class="col-md-7">
                        	<input id="Permanent" name="Permanent"  type="checkbox" class="form-control input-md" />
                          </div>
                          </div>
                       </div>
					  ...
					  <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          <label class="col-md-5 control-label" for="code"><div align="left">  ایمیل   </div></label>  
                          <div class="col-md-7">
                        	<input id="Email" name="Email"   type="checkbox"   class="form-control input-md" />
                          </div>
                          </div>
                       </div>	
            ...
            <div class="form-group">
                  <div class="text-center">
          	        ...
          	        <?php if (! (!empty($technicalcomments_register->flagattestation) )): ?>  
...
<?php elseif($technicalcomments_register->adminapproval == 2): ?>
