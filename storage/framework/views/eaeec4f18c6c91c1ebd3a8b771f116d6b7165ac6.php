...
<?php $__env->startSection('page-content'); ?>
                                ...
                                <div class="col-xs-12 pull-left nopadmar">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6">
                                            ...
                                            <h4 id="myTargetElement1.1">  <a style="border-left:2px solid grey" class="btn btn-primary" href="<?php echo e('/admin_doctor'); ?>"><?php echo e($total_doctors); ?></a> 
            </h4>
                                        </div>
                                        <div class="col-xs-6 text-right">
                                            <small class="stat-label">Total Universities</small>
                                            <h4 id="myTargetElement1.2">  	  <a style="border-left:2px solid grey" class="btn btn-primary" href="<?php echo e('/university'); ?>"><?php echo e($total_unis); ?></a> 
           </h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 pull-left nopadmar">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6">
                                            ...
                                            <h4 id="myTargetElement2.1"> <a style="border-left:2px solid grey" class="btn btn-primary" href="<?php echo e('/pending'); ?>"><?php echo e($total_pending); ?></a> 
           </h4>
                                        </div>
                                        <div class="col-xs-6 text-right">
                                            <small class="stat-label">Total Approved</small>
                                            <h4 id="myTargetElement2.2"> <a style="border-left:2px solid grey" class="btn btn-primary" href="<?php echo e('/approval'); ?>"><?php echo e($total_approved); ?></a> 
           </h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 pull-left nopadmar">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6">
                                            ...
                                            <h4 id="myTargetElement3.1"> <a style="border-left:2px solid grey" class="btn btn-primary" href="<?php echo e('/rejection'); ?>"><?php echo e($total_rejected); ?></a> 
            </h4>
                                        </div>
                                        <div class="col-xs-6 text-right">
                                            <small class="stat-label">Registered Users</small>
                                            <h4 id="myTargetElement3.2"><a style="border-left:2px solid grey"  class="btn btn-primary" href="<?php echo e('/usertable'); ?>"><?php echo e($total_users); ?> </a> 								
          </h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 pull-left nopadmar">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6">
                                            ...
                                            <h4 id="myTargetElement4.1"><a style="border-left:2px solid grey"  class="btn btn-primary" href="<?php echo e('/usertable'); ?>"><?php echo e($total_users); ?> </a></h4>
                                        </div>
                                        <div class="col-xs-6 text-right">
                                            <small class="stat-label">Total Master/PHD</small>
                                            <h4 id="myTargetElement4.2"><a style="border-left:2px solid grey"  class="btn btn-primary" href="<?php echo e('/usertable'); ?>"><?php echo e($total_users); ?> </a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
   ...
   <!--      Students By Registration Type            -->
            ...
            <?php elseif(Auth::user()->status == 0): ?>
			<center><h1><div></div><?php echo e(__('ui-list.a1')); ?></div> </h2> <br/>
				
					      <?php if(Auth::user()->status == 0 && Auth::user()->lastName != 'Balakarzai' && Auth::user()->lastName != 'Attestation'
                    ...
                    <?php else: ?>
					   ...
					   <a href="<?php echo e('/notification'); ?>"  > <button type="button" class="btn btn-danger">پیام های وزارت تحصیلات عالی را بررسی کنید</button> </a>
					...
					<!--	<center>Your Account is <?php echo e(auth()->user()->verified() ? 'Verified' :  'Not Verified'); ?></center>  -->
					
				
				
					<!-- Put this inside if statement below of user verified -->
                    <a href="<?php echo e('/personal_detail'); ?>"  class="submit"><font color="white"> تایید لیسانس یا ماستری یا دوکتورا</font></a>
										
					<!--	  <?php if(auth()->user()->verified()): ?> -->
						  <center>
										<!--	<a href="<?php echo e('/personal_detail'); ?>"  class="submit"><font color="white"> <?php echo e(__('ui-list.bachelorAttestation')); ?></font></a>-->
											
												<br/><br/>
											
											<!--	<a href="<?php echo e('/personal_detailMaster'); ?>" class="submit1"><font color="white"> <?php echo e(__('ui-list.MasterAttestation')); ?></font></a>
							
													
												<br/><br/>
												
											
												<a href="<?php echo e('/personal_detailPHD'); ?>" class="submit2"><font color="white"><?php echo e(__('ui-list.PHDAttestation')); ?> </font></a>-->
               ...
               <?php else: ?>
						   ...
						   <a href="<?php echo e('#'); ?>"><font size="2px" color="black" ><h3><?php echo e(__('ui-list.printpreview')); ?>   
						   
						    <?php if(App::getLocale()=='en'): ?>
							<!-- <img src="<?php echo e(Storage::url('public/documents/download.png')); ?>" width="100px" height="50px">--> 
						    <?php elseif(App::getLocale()=='fa' || App::getLocale()=='ps'): ?>
							<!-- <img src="<?php echo e(Storage::url('public/documents/right.png')); ?>" width="100px" height="50px"> -->
...
<?php $__env->startSection('scripts'); ?>
  <script type="text/javascript" src="<?php echo e(URL::asset('vendors/Chart.js/dist/Chart.bundle.min.js')); ?>"></script>
  ...
  $(".submit2").click(function() {
   ...
   <script>
	...
	var Rejected = <?php echo e($total_rejected); ?>;
    var Pending = <?php echo e($total_pending); ?>;
    var Approved = <?php echo e($total_approved); ?>;
