...
<?php $__env->startSection('page-content'); ?>
 ...
 <?php if(Auth::user()->lastName == "Attestation"): ?>
	    	...
	    	<div class="col-md-4 col-sm-6 col-xs-12">
                       ...
                       <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                          <input id="reg_no" name="reg_no" required  readonly type="text" value="<?php echo e($doctor->father_name); ?>" class="form-control input-md">   
                          </div>
                          </div>
                       </div>
					...
					<br/>
				    	...
				    	<div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                          <input id="reg_no" name="reg_no" required  readonly type="text" value="<?php echo e($doctor->EducationLevel); ?>" class="form-control input-md">   
                          </div>
                          </div>
                       </div>
                       ...
                       <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                          <input id="reg_no" name="reg_no" required  readonly type="text" value="<?php echo e($doctor->nic); ?>" class="form-control input-md">   
                          </div>
                          </div>
                       </div>
                       <br/>
                       ...
                       <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                          <input id="reg_no" name="reg_no" required  readonly type="text" value="<?php echo e($doctor->AYear); ?>" class="form-control input-md">   
                          </div>
                          </div>
                       </div>
                        <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                          <input id="reg_no" name="reg_no" required  readonly type="text" value="<?php echo e($doctor->GYear); ?>" class="form-control input-md">   
                          </div>
                          </div>
                       </div>
                       <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                          <input id="reg_no" name="reg_no" required  readonly type="text" value="<?php echo e($doctor->PersonalEmail); ?>" class="form-control input-md">   
                          </div>
                          </div>
                       </div>
	...
	<!-- Text input-->
	    	...
	    	<div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                          <input id="reg_no" name="reg_no" required  readonly type="text" value="<?php echo e($doctor->PersonalCellPhone); ?>" class="form-control input-md">   
                          </div>
                          </div>
                       </div>
                       <div class="col-md-4 col-sm-6 col-xs-12">
                       ...
                       <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                          <input id="reg_no" name="reg_no" required  readonly type="text" value="<?php echo e($doctor->StudyDuration); ?>" class="form-control input-md">   
                          </div>
                          </div>
                       </div>
                         ...
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                               ...
                               <?php if($doctor->typeScholarship == 1): ?>
                                   <input id="reg_no" name="reg_no" required  readonly type="text" value="<?php echo e(__('ui-list.Government')); ?>" class="form-control input-md">   
								  <?php elseif($doctor->typeScholarship == 2): ?>
								    <input id="reg_no" name="reg_no" required  readonly type="text" value="<?php echo e(__('ui-list.Private')); ?>" class="form-control input-md">   
			...
			<div class="row">
 			<div class="col-md-10 col-sm-15 col-xs-14">
				...
				<div class="col-md-12 col-sm-15 col-xs-14">
					...
					<div class="x_content">
							<br />
						<form  action="<?php echo e('/check_list1/'); ?>" method="post" class="form-horizontal form-label-left">
                    ...
                    <?php if (! (empty($attestationcomments_register->adminapproval) )): ?>  
                    <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          <label class="col-md-5 control-label" for="code"><div align="left">نمبر دیپلوم:      </div></label>  
                          <div class="col-md-7">
                          <input id="DiplomaNumber" name="DiplomaNumber"    type="text" value="<?php echo e($attestationcomments_register->DiplomaNumber); ?>" class="form-control input-md">   
                          </div>
                          </div>
                       </div>
                       ...
                       <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                          <input id="University" name="University"    type="text" value="<?php echo e($attestationcomments_register->University); ?>" class="form-control input-md">   
                          </div>
                          </div>
                       </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                          <input id="EducationField" name="EducationField"    type="text" value="<?php echo e($attestationcomments_register->EducationField); ?>" class="form-control input-md">   
                          </div>
                          </div>
                       </div>
                       ...
                       <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                          <input id="Protocol" name="Protocol"    type="text" value="<?php echo e($attestationcomments_register->Protocol); ?>" class="form-control input-md">   
                          </div>
                          </div>
                       </div>
                       <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          <label class="col-md-5 control-label" for="code"><div align="left">نوعیت تحصیل: </div></label>  
                          <div class="col-md-7">
                               <input id="EducationLevel" name="EducationLevel"    type="text" value="<?php echo e($attestationcomments_register->EducationLevel); ?>" class="form-control input-md">  
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                                   ...
                                   <input id="Thesis" name="Thesis"    type="text" value="<?php echo e($attestationcomments_register->Thesis); ?>" class="form-control input-md">  
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                                   ...
                                   <input id="AttestationType" name="AttestationType"    type="text" value="<?php echo e($attestationcomments_register->AttestationType); ?>" class="form-control input-md">  
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                                <input id="DocType" name="DocType"    type="text" value="<?php echo e($attestationcomments_register->DocType); ?>" class="form-control input-md">  
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                          <input id="nondocument" name="nondocument"   tabindex="27"  type="textarea" value="<?php echo e($attestationcomments_register->nondocument); ?>" class="form-control input-md">   
                          </div>
                          </div>
                       </div>
                    ...
                    <?php elseif(!empty($attestationcomments_register->flagattestation) ): ?>  
                         ...
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          <label class="col-md-5 control-label" for="code"><div align="left">نمبر دیپلوم:      </div></label>  
                          <div class="col-md-7">
                          <?php if (! (empty($attestationcomments_register->DiplomaNumber) )): ?>  
                       ...
                       <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          <label class="col-md-5 control-label" for="code"><div align="left"> پوهنتون:</div></label>  
                          <div class="col-md-7">
                          <?php if (! (empty($attestationcomments_register->University) )): ?>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          <label class="col-md-5 control-label" for="code"><div align="left">رشته تحصیلی:</div></label>  
                          <div class="col-md-7">
                          <?php if (! (empty($attestationcomments_register->EducationField) )): ?>
                       ...
                       <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          <label class="col-md-5 control-label" for="code"><div align="left"> پروتوکول:</div></label>  
                          <div class="col-md-7">
                          <?php if (! (empty($attestationcomments_register->Protocol) )): ?>
                       ...
                       <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          <label class="col-md-5 control-label" for="code"><div align="left">نوعیت تحصیل: </div></label>  
                          <div class="col-md-7">
                          <?php if (! (empty($attestationcomments_register->EducationLevel) )): ?>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          <label class="col-md-5 control-label" for="code"><div align="left"> تیزس  : </div></label>  
                          <div class="col-md-7">
                          <?php if (! (empty($attestationcomments_register->Thesis) )): ?>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          <label class="col-md-5 control-label" for="code"><div align="left">نوعیت تایید : </div></label>  
                          <div class="col-md-7">
                          <?php if (! (empty($attestationcomments_register->AttestationType) )): ?>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          <label class="col-md-5 control-label" for="code"><div align="left">نوع اسناد </div></label>  
                          <div class="col-md-7">
                          <?php if (! (empty($attestationcomments_register->DocType) )): ?>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          <label class="col-md-5 control-label" for="code"><div align="left">کمنت      </div></label>  
                          <div class="col-md-7">
                          <?php if (! (empty($attestationcomments_register->nondocument) )): ?>
                     ...
                     <?php else: ?>
                       ...
                       <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                          <?php if (! (empty($attestationcomments_register->EducationLevel) )): ?>
                               <input id="EducationLevel" name="EducationLevel"  disabled  type="text" value="<?php echo e($attestationcomments_register->EducationLevel); ?>" class="form-control input-md">  
                               <?php else: ?>
                               <select id="EducationLevel"  tabindex="15"  name="EducationLevel" class="form-control" >
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                          <?php if (! (empty($attestationcomments_register->Thesis) )): ?>
                                   <input id="Thesis" name="Thesis" disabled   type="text" value="<?php echo e($attestationcomments_register->Thesis); ?>" class="form-control input-md">  
                                   <?php else: ?>
                                   <select id="Thesis"  tabindex="15"  name="Thesis" class="form-control" >
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                          <?php if (! (empty($attestationcomments_register->AttestationType) )): ?>
                                   <input id="AttestationType" name="AttestationType" disabled   type="text" value="<?php echo e($attestationcomments_register->AttestationType); ?>" class="form-control input-md">  
                                   <?php else: ?>
                                   <select id="AttestationType"  tabindex="15"  name="AttestationType" class="form-control" >
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                          <?php if (! (empty($attestationcomments_register->DocType) )): ?>
                                <input id="DocType" name="DocType"  disabled  type="text" value="<?php echo e($attestationcomments_register->DocType); ?>" class="form-control input-md">  
                                <?php else: ?>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                          <input id="reg_no" name="reg_no" required   readonly  type="text"  value="<?php echo e($doctor->reg_no); ?>" class="form-control input-md">   
                          </div>
                          </div>
                       </div>
 			...
 			<div class="col-md-10 col-sm-15 col-xs-14">
				...
				<div class="col-md-12 col-sm-15 col-xs-14">
				    ...
				    <input id="flagattestation" name="flagattestation"  style="display:none"  type="text" value="1" class="form-control input-md">   
                         ...
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                             ...
                             <input id="" name=""    type="text" value="<?php echo e($technicalcomments_register->page); ?>" readonly class="form-control input-md">   
                             <?php endif; ?>
                         ...
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                             ...
                             <?php if (! ( empty($technicalcomments_register->jild) )): ?>
                              <input id="" name=""    type="text" value="<?php echo e($technicalcomments_register->jild); ?>" readonly class="form-control input-md">   
                             <?php endif; ?>
                       ...
                       <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                             ...
                             <input id="" name=""    type="text" value="<?php echo e($technicalcomments_register->EducationType); ?>" readonly class="form-control input-md">   
                             <?php endif; ?>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="form-group <?php echo e($errors->has('code')?'has_error':''); ?>">
                          ...
                          <div class="col-md-7">
                             ...
                             <input id="" name=""    type="text" value="<?php echo e($technicalcomments_register->nondocument); ?>" readonly class="form-control input-md">   
                             <?php endif; ?>
                  ...
                  <?php if (! ( empty($technicalcomments_register->Temporary) )): ?>
                    <?php if($technicalcomments_register->Temporary == "3" ): ?>
                 ...
                 <?php endif; ?>         
                  ...
                  <?php if (! ( empty($technicalcomments_register->Permanent) )): ?>    
                      <?php if($technicalcomments_register->Permanent == "3" ): ?>
					 ...
					 <?php endif; ?>
					  ...
					  <?php if (! ( empty($technicalcomments_register->Email) )): ?>   
					   <?php if($technicalcomments_register->Email == "3" ): ?>
		 ...
		 <div class="form-group">
                     <div class="text-center">
          	        <?php if (! (!empty($attestationcomments_register->flagattestation) )): ?>  
...
<?php elseif($attestationcomments_register->adminapproval == 2): ?>
